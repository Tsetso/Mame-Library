...
#define NUMBER_OF_DEFAULT_SMART_COLLECTION 5
...
//	NSLog(@"collections: %@",collections);
    ...
    BOOL importDefaultSmart = [[NSUserDefaults standardUserDefaults] boolForKey:@"MLDidImportDefaultSmartCollections"];
    
//    importDefaultSmart = YES;
	if (!importDefaultSmart) {
